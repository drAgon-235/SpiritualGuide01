package com.example.spiritualguide01.home.cards.cardsUI.cardReadings.loveOracle
...
import com.example.spiritualguide01.databinding.FragmentLoveOracleMeaningBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.card01CV.setOnClickListener {
            ...
            findNavController().navigate(
                LoveOracleMeaningFragmentDirections.actionLoveOracleMeaningFragmentToOneCardFragment(
                    id01
                )
            )
        }
